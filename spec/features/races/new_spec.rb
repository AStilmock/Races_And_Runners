...
RSpec.describe "races new page" do
  ...
  it "creates new races" do
    ...
    fill_in "race[location]", with: "Lakewood"
    fill_in "race[terrain]", with: "road_pavement"
    fill_in "race[weather]", with: "sunny"
    fill_in "race[length]", with: 50
    fill_in "race[loop]", with: true
    fill_in "race[overnight]", with: true
